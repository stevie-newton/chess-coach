export const openingDetails = {
  "Italian Game": {
    color: "White",
    mainLine: ["1. e4 e5", "2. Nf3 Nc6", "3. Bc4 Bc5", "4. c3 Nf6", "5. d3 d6", "6. O-O O-O", "7. Re1 a6", "8. Bb3 Ba7", "9. h3 h6"],
    moveExplanations: [
      ...
      "Bc5 mirrors the active bishop and challenges White's control of d4.",
      "c3 prepares d4 and gives the bishop a retreat square.",
      "Nf6 develops with pressure on e4.",
      "d3 supports e4 and keeps the center stable.",
      "d6 reinforces e5 and prepares kingside castling.",
      "O-O brings the king to safety before central play opens.",
      "O-O completes Black's development plan and connects the rook soon.",
      "Re1 supports e4 and prepares central expansion.",
      "a6 asks the bishop to choose a square and creates queenside space.",
      "Bb3 preserves the bishop on the f7 diagonal.",
      "Ba7 keeps Black's bishop active on the long diagonal.",
      "h3 stops Bg4 pins and gives the king luft.",
      "h6 prevents Bg5 and gives Black a useful waiting move.",
    ],
  ...
  "Ruy Lopez": {
    color: "White",
    mainLine: ["1. e4 e5", "2. Nf3 Nc6", "3. Bb5 a6", "4. Ba4 Nf6", "5. O-O Be7", "6. Re1 b5", "7. Bb3 d6", "8. c3 O-O", "9. h3 Na5", "10. Bc2 c5"],
    moveExplanations: [
      ...
      "a6 questions the bishop and gains queenside space.",
      "Ba4 keeps the pin idea without trading immediately.",
      "Nf6 attacks e4 and develops a kingside piece.",
      "O-O secures the king before the center opens.",
      "Be7 prepares castling and avoids tactical pressure.",
      "Re1 reinforces e4 and prepares central expansion.",
      "b5 gains space and pushes the bishop to a quieter diagonal.",
      "Bb3 keeps the bishop aimed at f7 and d5.",
      "d6 protects e5 and builds a flexible center.",
      "c3 prepares d4 and gives the bishop room on c2.",
      "O-O completes Black's king safety.",
      "h3 prevents Bg4 pins and waits for Black's setup.",
      "Na5 attacks the bishop and clears c6 for the c-pawn or queen.",
      "Bc2 preserves the bishop pair and eyes h7.",
      "c5 challenges White's center before d4 becomes too strong.",
    ],
  ...
  "London System": {
    color: "White",
    mainLine: ["1. d4 d5", "2. Bf4 Nf6", "3. e3 e6", "4. Nf3 c5", "5. c3 Nc6", "6. Nbd2 Bd6", "7. Bg3 O-O", "8. Bd3 b6", "9. O-O Bb7"],
    moveExplanations: [
      ...
      "e6 builds a solid center and prepares development.",
      "Nf3 develops naturally and controls e5.",
      "c5 challenges White's d4 pawn before the setup becomes too comfortable.",
      "c3 supports the d4 pawn and creates the London triangle.",
      "Nc6 increases pressure on d4 and e5.",
      "Nbd2 adds support to e4 and keeps the structure flexible.",
      "Bd6 challenges White's active bishop.",
      "Bg3 preserves the bishop and keeps pressure on the diagonal.",
      "O-O brings Black's king to safety.",
      "Bd3 points at h7 and completes White's minor-piece setup.",
      "b6 prepares Bb7 and fights the long diagonal.",
      "O-O finishes king safety and connects the rook soon.",
      "Bb7 develops the bishop toward the center.",
    ],
  ...
  "Queen's Gambit": {
    color: "White",
    mainLine: ["1. d4 d5", "2. c4 e6", "3. Nc3 Nf6", "4. Bg5 Be7", "5. e3 O-O", "6. Nf3 h6", "7. Bh4 b6", "8. cxd5 Nxd5", "9. Bxe7 Qxe7"],
    moveExplanations: [
      ...
      "e6 supports d5 and keeps a solid central structure.",
      "Nc3 increases pressure on d5 and supports e4.",
      "Nf6 develops and fights for e4.",
      "Bg5 pins the knight and increases pressure.",
      "Be7 prepares castling and breaks the pin when needed.",
      "e3 supports d4 and opens the bishop.",
      "O-O secures Black's king.",
      "Nf3 develops and supports central control.",
      "h6 asks the bishop to decide its future.",
      "Bh4 keeps the pin and avoids giving up the bishop too early.",
      "b6 prepares Bb7 and contests the long diagonal.",
      "cxd5 clarifies the center at a good moment.",
      "Nxd5 recaptures actively and centralizes the knight.",
      "Bxe7 removes a defender before Black fully untangles.",
      "Qxe7 recaptures and keeps Black coordinated.",
    ],
  ...
  "English Opening": {
    color: "White",
    mainLine: ["1. c4 e5", "2. Nc3 Nf6", "3. g3 d5", "4. cxd5 Nxd5", "5. Bg2 Nb6", "6. Nf3 Nc6", "7. O-O Be7", "8. d3 O-O"],
    moveExplanations: [
      ...
      "d5 strikes in the center before White finishes the fianchetto.",
      "cxd5 removes Black's advanced central pawn.",
      "Nxd5 recaptures actively and centralizes the knight.",
      "Bg2 completes the fianchetto and attacks the long diagonal.",
      "Nb6 retreats while keeping control of d5 and c4.",
      "Nf3 develops and prepares castling.",
      "Nc6 develops and supports the central knight.",
      "O-O makes the king safe.",
      "Be7 prepares castling and keeps the structure flexible.",
      "d3 supports e4 ideas and opens the c1 bishop.",
      "O-O completes Black's development goal.",
    ],
  ...
  "Vienna Game": {
    color: "White",
    mainLine: ["1. e4 e5", "2. Nc3 Nf6", "3. f4 d5", "4. fxe5 Nxe4", "5. Nf3 Be7", "6. d3 Nxc3", "7. bxc3 O-O", "8. d4 c5", "9. Bd3 Nc6"],
    moveExplanations: [
      ...
      "d5 counters immediately in the center.",
      "fxe5 accepts the challenge and opens the f-file.",
      "Nxe4 centralizes Black's knight and restores material balance.",
      "Nf3 develops and attacks the advanced knight.",
      "Be7 prepares castling and keeps Black compact.",
      "d3 kicks the knight and supports the center.",
      "Nxc3 removes a defender and changes the pawn structure.",
      "bxc3 opens the b-file and keeps central pawns available.",
      "O-O brings Black's king to safety.",
      "d4 claims space and opens lines for White's bishops.",
      "c5 challenges White's central pawns.",
      "Bd3 develops toward h7 and supports castling.",
      "Nc6 adds pressure to d4 and e5.",
    ],
  ...
  "Sicilian Defense": {
    color: "Black",
    mainLine: ["1. e4 c5", "2. Nf3 d6", "3. d4 cxd4", "4. Nxd4 Nf6", "5. Nc3 Nc6", "6. Be2 e5", "7. Nb3 Be7", "8. O-O O-O", "9. Be3 Be6"],
    moveExplanations: [
      ...
      "Nxd4 centralizes the knight and keeps piece activity.",
      "Nf6 develops with tempo against e4.",
      "Nc3 defends e4 and controls d5.",
      "Nc6 develops naturally and increases central pressure.",
      "Be2 prepares castling and avoids sharp bishop pins.",
      "e5 gains space and attacks the d4 knight.",
      "Nb3 retreats while keeping control of a5 and d4.",
      "Be7 prepares castling and keeps Black flexible.",
      "O-O brings White's king to safety.",
      "O-O completes Black's king safety.",
      "Be3 develops and supports queenside or central plans.",
      "Be6 challenges White's bishop and controls key dark squares.",
    ],
  ...
  "Sicilian Najdorf": {
    color: "Black",
    mainLine: ["1. e4 c5", "2. Nf3 d6", "3. d4 cxd4", "4. Nxd4 Nf6", "5. Nc3 a6", "6. Be3 e5", "7. Nb3 Be6", "8. f3 Be7", "9. Qd2 O-O", "10. O-O-O Nbd7"],
    moveExplanations: [
      "e4 takes central space.",
      ...
      "Be3 develops and prepares the English Attack setup.",
      "e5 gains space and pushes the d4 knight away.",
      "Nb3 keeps the knight active while avoiding tempo losses.",
      "Be6 develops and controls important central squares.",
      "f3 supports e4 and prepares a kingside pawn storm.",
      "Be7 prepares castling and keeps Black solid.",
      "Qd2 connects rooks and prepares long castling.",
      "O-O gets Black's king safe before the pawn storms begin.",
      "O-O-O commits White to opposite-side castling and direct attack.",
      "Nbd7 reinforces f6 and prepares queenside counterplay.",
    ],
  ...
  "Sicilian Dragon": {
    color: "Black",
    mainLine: ["1. e4 c5", "2. Nf3 d6", "3. d4 cxd4", "4. Nxd4 Nf6", "5. Nc3 g6", "6. Be3 Bg7", "7. f3 O-O", "8. Qd2 Nc6", "9. O-O-O Bd7", "10. Bc4 Rc8"],
    moveExplanations: [
      "e4 takes central space.",
      ...
      "Be3 prepares Qd2 and long castling.",
      "Bg7 completes the Dragon fianchetto.",
      "f3 supports e4 and prepares kingside pawn expansion.",
      "O-O gets Black's king safe before counterplay starts.",
      "Qd2 lines up the bishop and queen battery.",
      "Nc6 attacks d4 and increases central pressure.",
      "O-O-O starts the Yugoslav Attack race.",
      "Bd7 connects Black's pieces and supports queenside play.",
      "Bc4 develops actively and points at f7.",
      "Rc8 places the rook on the half-open c-file.",
    ],
  ...
  "King's Gambit": {
    color: "White",
    mainLine: ["1. e4 e5", "2. f4 exf4", "3. Nf3 g5", "4. Bc4 Bg7", "5. O-O d6", "6. d4 Nc6", "7. c3 h6", "8. Qb3 Qe7"],
    moveExplanations: [
      ...
      "exf4 accepts the gambit and tests White's compensation.",
      "Nf3 develops and stops early queen checks.",
      "g5 protects the extra pawn and grabs space.",
      "Bc4 develops with pressure on f7.",
      "Bg7 develops while guarding the long diagonal.",
      "O-O brings the king away from the open center.",
      "d6 supports e5 and opens Black's bishop.",
      "d4 claims the center and opens lines for the pieces.",
      "Nc6 develops and pressures d4.",
      "c3 supports d4 and builds a broad center.",
      "h6 reinforces g5 and prepares kingside stability.",
      "Qb3 increases pressure on f7 and b7.",
      "Qe7 defends key targets and prepares development.",
    ],
  ...
  "French Defense": {
    color: "Black",
    mainLine: ["1. e4 e6", "2. d4 d5", "3. e5 c5", "4. c3 Nc6", "5. Nf3 Qb6", "6. a3 Nh6", "7. b4 cxd4", "8. cxd4 Nf5", "9. Bb2 Be7"],
    moveExplanations: [
      "e4 takes central space.",
      ...
      "e5 gains space and creates the French pawn chain.",
      "c5 attacks the base of White's center.",
      "c3 reinforces d4.",
      "Nc6 adds pressure to d4 and supports central breaks.",
      "Nf3 develops and protects d4.",
      "Qb6 pressures d4 and b2 at the same time.",
      "a3 prepares b4 and controls b4.",
      "Nh6 heads toward f5 to pressure d4.",
      "b4 gains queenside space and chases the c5 pawn.",
      "cxd4 opens the c-file and reduces White's center.",
      "cxd4 keeps a strong pawn chain.",
      "Nf5 increases pressure on d4 and h4.",
      "Bb2 develops and protects the long diagonal.",
      "Be7 prepares castling and completes kingside development.",
    ],
  ...
  "Caro-Kann": {
    color: "Black",
    mainLine: ["1. e4 c6", "2. d4 d5", "3. Nc3 dxe4", "4. Nxe4 Bf5", "5. Ng3 Bg6", "6. h4 h6", "7. Nf3 Nd7", "8. h5 Bh7", "9. Bd3 Bxd3"],
    moveExplanations: [
      "e4 takes central space.",
      "c6 supports a solid d5 break.",
      "d4 builds the broad pawn center.",
      "d5 challenges e4 while keeping a healthy structure.",
      "Nc3 defends e4 and develops.",
      "dxe4 resolves the center and enters the Classical line.",
      "Nxe4 recaptures with active central development.",
      "Bf5 develops the light bishop before e6.",
      "Ng3 attacks the bishop and keeps pressure.",
      "Bg6 preserves the bishop pair.",
      "h4 gains space and asks the bishop another question.",
      "h6 gives the bishop a safe retreat square.",
      "Nf3 develops and supports kingside safety.",
      "Nd7 supports f6 and prepares Ngf6.",
      "h5 forces the bishop to clarify its position.",
      "Bh7 keeps the bishop active on the diagonal.",
      "Bd3 challenges Black's bishop and develops.",
      "Bxd3 removes White's active bishop.",
    ],
  ...
  "Scandinavian": {
    color: "Black",
    mainLine: ["1. e4 d5", "2. exd5 Qxd5", "3. Nc3 Qa5", "4. d4 Nf6", "5. Nf3 c6", "6. Bc4 Bf5", "7. O-O e6", "8. Ne5 Nbd7"],
    moveExplanations: [
      "e4 takes central space.",
      ...
      "d4 builds a strong center.",
      "Nf6 develops and attacks central squares.",
      "Nf3 supports d4 and prepares castling.",
      "c6 gives the queen a retreat and supports a solid structure.",
      "Bc4 develops actively toward f7.",
      "Bf5 develops before e6 and fights for c2.",
      "O-O secures the king.",
      "e6 strengthens dark squares and frees the bishop.",
      "Ne5 centralizes the knight and increases pressure.",
      "Nbd7 challenges the knight and completes development.",
    ],
  ...
  "King's Indian": {
    color: "Black",
    mainLine: ["1. d4 Nf6", "2. c4 g6", "3. Nc3 Bg7", "4. e4 d6", "5. Nf3 O-O", "6. Be2 e5", "7. O-O Nc6", "8. d5 Ne7", "9. Ne1 Nd7"],
    moveExplanations: [
      ...
      "e4 builds the broad classical center.",
      "d6 supports e5 and keeps the position flexible.",
      "Nf3 develops and protects d4.",
      "O-O brings Black's king to safety.",
      "Be2 prepares castling and avoids early tactics.",
      "e5 strikes at White's center.",
      "O-O secures White's king.",
      "Nc6 increases pressure on d4 and e5.",
      "d5 gains space and starts the typical pawn-chain race.",
      "Ne7 reroutes the knight for kingside play.",
      "Ne1 prepares f3 and kingside/central support.",
      "Nd7 supports c5 or f5 breaks.",
    ],
  ...
  "Slav Defense": {
    ...
    moveExplanations: [
      ...
      "Nf6 develops and protects d5.",
      "Nc3 increases pressure on d5 and e4.",
      "dxc4 grabs the c-pawn after White commits the knight.",
      "a4 prevents Black from holding the pawn with b5.",
      "Bf5 develops the light bishop actively.",
      "e3 opens the bishop and prepares to recover c4.",
      "e6 supports d5 and frees the dark bishop.",
      "Bxc4 regains the pawn and completes development.",
      "Bb4 pins the knight and increases pressure.",
      "O-O brings White's king to safety.",
      "O-O completes Black's development plan.",
    ],
